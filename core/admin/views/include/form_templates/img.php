<div class="vg-wrap vg-element vg-full vg-box-shadow img_container img_wrapper ">
    <div class="vg-wrap vg-element vg-half">
        <div class="vg-wrap vg-element vg-full">
            ...
            <div class="vg-element vg-full vg-left">
                <span class="vg-text vg-firm-color5 vg_subheader">
        ...
        <div class="vg-wrap vg-element vg-full">
            <div class="vg-element vg-left img_show main_img_show">
                <?php if ($this->data[$row]) : ?>
                    <img src="<?= file_exists($_SERVER['DOCUMENT_ROOT'] . PATH . UPLOAD_DIR . $this->data[$row]) ? PATH . UPLOAD_DIR . $this->data[$row] : PATH . ADMIN_TEMPLATE . 'img/img-not-found.png'; ?>">
                <?php endif; ?>
            </div>
        </div>
    </div>
